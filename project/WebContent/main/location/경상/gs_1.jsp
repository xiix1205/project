...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">동성아트홀</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>대구광역시 중구 동성로1가 동성로 69</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>053-425-2845</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.artmovie.co.kr/" target="_blank">http://www.artmovie.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.872944, 128.595605),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.872944,128.595605)   

...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">안동 중앙아트시네마</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>경상북도 안동시 삼산동 문화광장길 45</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>054-854-5500</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://cafe.naver.com/joongangcinema" target="_blank">http://cafe.naver.com/joongangcinema</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(36.565134, 128.730756),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(36.565134, 128.730756)   

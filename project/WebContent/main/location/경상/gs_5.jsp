...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">CGV 서면 아트하우스</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>부산광역시 부산진구 동천로 4 지오플레이스 6층</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-1122</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.cgv.co.kr/theaters/?areacode=11%2C207%2C05&theaterCode=0005&date=20151228" target="_blank">http://www.cgv.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.149294, 129.063748),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.149294, 129.063748)   

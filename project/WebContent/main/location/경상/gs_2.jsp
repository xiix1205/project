...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">대구 오오극장</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>대구광역시 중구 국채보상로 537</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>053-425-3553</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://55cine.com/" target="_blank">http://55cine.com/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.870452, 128.589456),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.870452, 128.589456)   

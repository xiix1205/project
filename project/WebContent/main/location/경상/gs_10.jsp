...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">씨네아트 리좀</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>경상남도 창원시 마산합포구 동서북14길 24</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>070-8802-6438</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.espacerhizome.com/main/main.php" target="_blank">www.espacerhizome.com</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.205924, 128.575820),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.205924, 128.575820)   

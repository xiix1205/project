...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">롯데시네마 센텀시티 아르떼클래식</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>부산광역시 해운대구 우동 센텀남대로 59 롯데백화점 8층</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-8855</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.lottecinema.co.kr/LCHS/Contents/Cinema/Cinema-Detail.aspx?divisionCode=1&detailDivisionCode=101&cinemaID=2006" target="_blank">http://www.lottecinema.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.169652, 129.131096),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.169652, 129.131096)   

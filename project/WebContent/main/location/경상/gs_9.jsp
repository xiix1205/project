...
-->             
           ...
           <div id="the_info">
               <caption><p class="info_name">김해 문화의전당</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>경상남도 김해시 내동 김해대로 2060</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>055-320-1234</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.gasc.or.kr/" target="_blank">http://www.gasc.or.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.243618, 128.869415),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.243618, 128.869415)   

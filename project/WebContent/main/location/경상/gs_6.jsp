...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">영화의 전당</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>부산광역시 해운대구 우동 수영강변대로 120</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>051-780-6000</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.dureraum.org/" target="_blank">http://www.dureraum.org/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.171151, 129.127185),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.171151, 129.127185)   

...
-->             
        ...
        <div id="the_info">
               ...
               <table id="info_table" border="1" align="center">
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="https://daihancinema.modoo.at/" target="_blank">https://daihancinema.modoo.at/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.491005,126.722323),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.491005,126.722323)    

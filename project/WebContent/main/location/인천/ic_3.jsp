...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">영화공간 주안</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>인천광역시 남구 주안1동 미추홀대로 716</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>032-427-6777</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.cinespacejuan.com/" target="_blank">http://www.cinespacejuan.com/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.461232,126.680599),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.461232,126.680599)    

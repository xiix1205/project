...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">CGV 인천 아트하우스</p></caption>
               <table id="info_table" border="1" align="center">
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.cgv.co.kr/theaters/?areacode=202&theaterCode=0002" target="_blank">http://www.cgv.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.451633,126.701909),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.451633,126.701909)    

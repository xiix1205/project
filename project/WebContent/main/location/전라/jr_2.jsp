...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">시네마라운지MM</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>전라남도 목포시 수강로 4번길 19</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>010-8702-4898 </td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://cinemaloungemm.modoo.at/" target="_blank">http://cinemaloungemm.modoo.at/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
  ...
  <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(34.786785, 126.387354),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(34.786785, 126.387354),    

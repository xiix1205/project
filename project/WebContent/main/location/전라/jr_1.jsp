...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">익산 재미극장</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>전북 익산시 인북로 424</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>070-8282-8070~2</td>
                </tr>
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.ismedia.or.kr/" target="_blank">http://www.ismedia.or.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.965551, 126.964424),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.965551, 126.964424),    

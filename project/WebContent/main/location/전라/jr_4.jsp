...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">전주 영화제작소</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>전라북도 전주시 완산구 전주객사3길 22</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>063-231-3377</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.jeonjucinecomplex.kr/" target="_blank">http://www.jeonjucinecomplex.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.818341, 127.142753),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.818341, 127.142753),    

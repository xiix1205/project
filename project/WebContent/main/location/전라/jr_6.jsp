...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">광주 독립영화관</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>광주광역시 동구 제봉로 96(서석동 47-1) 광주영상복합문화관 6층</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>062-222-1895</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.gift4u.or.kr/" target="_blank">http://www.gift4u.or.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.146874, 126.922117),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.146874, 126.922117),    

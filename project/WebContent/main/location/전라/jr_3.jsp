...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">순천시 영상미디어센터 두드림</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>전라남도 순천시 금곡길 25 순천시영상미디어센터</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>061-811-0220</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="https://www.media-center.or.kr/suncheon/main.do" target="_blank">https://www.media-center.or.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(34.954693, 127.481935),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(34.954693, 127.481935),    

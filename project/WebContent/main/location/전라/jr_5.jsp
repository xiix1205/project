...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">CGV 광주터미널 아트하우스</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>광주광역시 서구 광천동 무진대로 904 유스퀘어 2층</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-1122</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.cgv.co.kr/theaters/?areacode=206%2C04%2C06&theaterCode=0090&date=20190528" target="_blank">http://www.cgv.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(35.160280, 126.879168),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(35.160280, 126.879168),    

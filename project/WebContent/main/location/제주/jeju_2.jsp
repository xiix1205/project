...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">제주 씨네아일랜드</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>제주특별자치도 제주시 일도1동 1279-2</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>064-702-1191</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.cineisland.org/" target="_blank">http://www.cineisland.org/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(33.515422,126.524345),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(33.515422,126.524345)    

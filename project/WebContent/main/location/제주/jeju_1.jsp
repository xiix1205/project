...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">제주 영상미디어센터</p></caption>
               <table id="info_table" border="1" align="center">
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://jejufc.or.kr/" target="_blank">http://jejufc.or.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(33.505473,126.534513),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(33.505473,126.534513)    

...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">원주영상미디어센터</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>강원도 원주시 원일로 139</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>033-733-8020</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.wonjumc.kr/" target="_blank">http://www.wonjumc.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.351589, 127.946759),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.351589, 127.946759),    

...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">강릉독립예술극장 신영</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>강원도 강릉시 임당동 119-3</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>033-645-7415</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://theque.tistory.com/" target="_blank">http://theque.tistory.com/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.754768, 128.896607),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.754768, 128.896607),    

...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">인디플러스 천안</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>충청남도 천안시 동남구 중앙로 111</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>041-415-0093</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.xn--2z1bz7ch1njvc5tdy9k60p.kr/" target="_blank">http://www.xn--2z1bz7ch1njvc5tdy9k60p.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(36.808615, 127.152223),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(36.808615, 127.152223),    

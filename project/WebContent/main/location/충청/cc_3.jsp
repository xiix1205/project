...
-->             
          ...
          <div id="the_info">
               <caption><p class="info_name">제천영상미디어센터 봄</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>충청북도 제천시 청전동 110</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>043-645-4995</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.jcbom.com/" target="_blank">http://www.jcbom.com/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.148641, 128.216382),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.148641, 128.216382),    

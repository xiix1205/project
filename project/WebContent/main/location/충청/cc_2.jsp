...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">대전 아트시네마</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td> 대전광역시 동구 중앙로 192 3층</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>042-472-1138</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="https://cafe.naver.com/artcinema/" target="_blank">https://cafe.naver.com/artcinema/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(36.330139, 127.430410),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(36.330139, 127.430410),    

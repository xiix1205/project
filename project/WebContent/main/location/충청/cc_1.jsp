...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">CGV 대전 아트하우스</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>대전광역시 중구 문화1동 계백로 1700</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-1122</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.cgv.co.kr/theaters/?areacode=03%2C205&theaterCode=0007" target="_blank">http://www.cgv.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(36.320670, 127.408874),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(36.320670, 127.408874),    

...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">대한극장</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>서울특별시 중구 필동 퇴계로 212</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>02-3393-3600</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.daehancinema.co.kr/" target="_blank">http://www.daehancinema.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.561047,126.995288),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.561047,126.995288),    

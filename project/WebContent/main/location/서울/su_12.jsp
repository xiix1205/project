...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">CGV 구로 아트하우스</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>서울특별시 구로구 구로동 구로중앙로 152</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-1122</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.cgv.co.kr/theaters/?areacode=01&theaterCode=0010&date=20190502" target="_blank">http://www.cgv.co.kr</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.501282, 126.882536),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.501282,126.882536),    

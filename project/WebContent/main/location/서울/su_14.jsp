...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">KT&G 상상마당 홍대</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>서울 마포구 서교동 367-5 문화플래닛 상상마당</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>02-330-6263</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.sangsangmadang.com" target="_blank">http://www.sangsangmadang.com</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.550921,126.921122),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.550921,126.921122),    

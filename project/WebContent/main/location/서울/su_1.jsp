...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">KU 씨네마테크</p></caption>
               
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>서울특별시 광진구 능동로 120 건국대학교 예술문화관 B108</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>02-446-6579</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://kucinema.net/" target="_blank">http://kucinema.net/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.543107, 127.073067),
			level: 3
		};
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.543107, 127.073067),    

...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">자체휴강 시네마</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>서울특별시 관악구 봉천동 180-531 태양빌딩 지하1층</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>010-9640-0987</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="https://huegang.com/" target="_blank">https://huegang.com/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.469722,126.938741),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.469722,126.938741),    

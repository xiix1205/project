...
-->             
       ...
       <div id="the_info">
               <caption><p class="info_name">한국영상자료원</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>서울특별시 마포구 상암동 월드컵북로 400</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>02-3153-2001</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.koreafilm.or.kr/" target="_blank">http://www.koreafilm.or.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.580395,126.889957),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.580395,126.889957),    

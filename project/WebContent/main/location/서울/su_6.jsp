...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">더숲 아트시네마</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>서울특별시 노원구 상계6.7동 노해로 480 조광 빌딩 B1</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>02-951-0206</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.forest6.co.kr/" target="_blank">http://www.forest6.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.654156,127.061422),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.654156,127.061422),    

...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">롯데시네마 건대입구 아르떼클래식</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>서울특별시 광진구 자양3동 아차산로 262</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-8855</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="https://www.lottecinema.co.kr" target="_blank">https://www.lottecinema.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.538497, 127.073139),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.538497, 127.073139),    

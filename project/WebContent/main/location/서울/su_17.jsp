...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">아트하우스 모모</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>서울특별시 서대문구 대현동 이화여대길 52</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>02-363-5333</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.arthousemomo.com/" target="_blank">http://www.arthousemomo.com/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.561345,126.947507),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.561345,126.947507),    

...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">메가박스 백석</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>경기도 고양시 일산동구 백석1동 중앙로 1036</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-0070</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.megabox.co.kr/?menuId=theater-detail&region=30&cinema=4113" target="_blank">http://www.megabox.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>

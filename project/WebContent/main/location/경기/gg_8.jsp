...
-->             
       ...
       <div id="the_info">
               <caption><p class="info_name">메가박스 영통</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>경기도 수원시 영통구 영통동 봉영로 1579</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-0070</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="https://megabox.co.kr/theater/time?brchNo=4431" target="_blank">https://megabox.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.252704,127.071632),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.252704,127.071632)    

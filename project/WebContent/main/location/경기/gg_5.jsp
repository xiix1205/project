...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">성남 영상미디어센터</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>경기도 성남시 분당구 성남대로 808 야탑동</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>031-724-8350</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://snmedia.or.kr/" target="_blank">http://snmedia.or.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.402727,127.131230),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.402727,127.131230),    

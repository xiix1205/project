...
-->             
        ...
        <div id="the_info">
               <caption><p class="info_name">CGV 소풍 아트하우스</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>경기도 부천시 원미구 상동 송내대로 239</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-1122</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.cgv.co.kr/" target="_blank">http://www.cgv.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
    ...
    var options = {
			center: new kakao.maps.LatLng(37.503910,126.756764),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.503910,126.756764),    

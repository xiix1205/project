...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">오산 문화예술회관</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>경기도 오산시 오산동 6-9</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>031-379-9900</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="https://www.osan.go.kr/arts/main.do" target="_blank">http://osan.go.kr/arts/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.159439,127.076777),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.159439,127.076777)    

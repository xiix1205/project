...
-->             
         ...
         <div id="the_info">
               <caption><p class="info_name">롯데시네마 주엽 아르떼클래식</p></caption>
               <table id="info_table" border="1" align="center">
                <tr>
                    <td>상세 주소</td>
                    <td>경기도 고양시 일산서구 주엽동 22</td>
                </tr>
                <tr>
                    <td>전화번호</td> 
                    <td>1544-8855</td>
                ...
                <tr>
                    <td>홈페이지</td> 
                    <td><a href="http://www.lottecinema.co.kr/LCHS/Contents/Cinema/Cinema-Detail.aspx?divisionCode=1&detailDivisionCode=2&cinemaID=3013" target="_blank">http://www.lottecinema.co.kr/</a></td>
                </tr>
                <tr>
                    <td width="200">지도</td>
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=953c1d4d4db1458d5c8700392f39c23d"></script>  
    ...
    var options = {
			center: new kakao.maps.LatLng(37.670821,126.760987),
			level: 3
		};
...
// 지도에 마커를 표시합니다
   ...
   if (navigator.geolocation) {
    ...
    var locPosition = new kakao.maps.LatLng(37.670821,126.760987),    
